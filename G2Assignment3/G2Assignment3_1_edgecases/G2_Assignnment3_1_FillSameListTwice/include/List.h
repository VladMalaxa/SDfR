...
public:
   ...
   void concatenate(List<NODETYPE>& otherList) {
    ...
    if (this->isEmpty()) {
        // if current list empty, take over other list
        firstPtr = otherList.firstPtr;
        lastPtr = otherList.lastPtr;
    } else {
        // connect last of this list to first of the new one
        lastPtr->nextPtr = otherList.firstPtr;
        lastPtr = otherList.lastPtr;
    }

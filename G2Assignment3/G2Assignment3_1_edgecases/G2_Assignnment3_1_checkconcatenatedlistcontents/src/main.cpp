...
// list3 is printed after being concatenated to check whether it is correctly emptied or not.
//==============================================================
...
int main() {    
    ...
    list1.print();
    list2.print();
    list3.print();      //This should show an empty list if concatenation is correctly implemented.
    return 0;
}

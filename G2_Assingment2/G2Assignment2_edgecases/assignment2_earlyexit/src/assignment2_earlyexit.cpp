...
//
// Brief : Edge case for the maze function where the maze has more than one exit.
//
//=============================================================================
...
int main()
{
    Maze maze = {{
        ...
        {{'#','.','.','.','.','.','.','#','.','.','.','#'}},
        {{'#','#','#','#','#','#','#','#','#','#','#','#'}}
    }};                                                         //The maze for this edge case has more than one possible exit. The program should find the fastest exit based on the starting direction.

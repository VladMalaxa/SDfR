...
//
// Brief : Edge case where the order of directions checked is completely changed.
//
//=============================================================================
...
void traverseMaze(Maze& maze, int r, int c, int startR, int startC)
{
    ...
    Direction directions[4] = {             //The priority for checked directions has been changed. We will start with UP now.
        Direction::Up,
        Direction::Left,
        Direction::Down,
        Direction::Right,

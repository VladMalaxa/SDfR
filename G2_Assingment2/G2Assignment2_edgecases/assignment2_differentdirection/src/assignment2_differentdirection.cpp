...
//
// Brief : Edge case where the direction priority is different.
//
//=============================================================================
...
void traverseMaze(Maze& maze, int r, int c, int startR, int startC)
{
    ...
    Direction directions[4] = {             //The initial checked direction has been changed. We will start with left now.
        Direction::Left,
        Direction::Down,
        Direction::Right,
        Direction::Up,

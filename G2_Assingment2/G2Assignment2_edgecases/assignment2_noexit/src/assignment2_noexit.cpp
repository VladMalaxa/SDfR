...
//
// Brief : Edge case for the maze function where the maze has no exits.
//
//=============================================================================
...
int main()
{
    Maze maze = {{
        ...
        {{'#','.','.','.','.','.','.','#','.','.','.','#'}},
        {{'#','#','#','#','#','#','#','#','#','#','#','#'}}
    }};                                                         //The maze for this edge case has no possible exit. The program should lead to the "No exit" case.
